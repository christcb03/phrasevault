...
1. **Vault core** — `pvfs-companion` crate: seal/unseal the seed (passphrase/Argon2id path first), lock/zeroize, vault file format + version. Unit tests for round-trip + tamper detection.
